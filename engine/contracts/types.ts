...
// overlay treats each `Part` as the leaf "Деталь" of the
// Block→Zone→Component→Part hierarchy (CONSTRUCTION_FRAME_v2.md:159-164) and
// refers to it by id, so both views share one truth and the SWJ008 path is
// unaffected.
// ---------------------------------------------------------------------------
